...
class SEO extends Component {
  render() {
    ...
    if (customTitle && postNode && postNode.title) {
      title = postNode.title
      pageUrl = config.siteUrl + '/' + pagePath + '/'
    }

    // Replace with Page Parameters if post or page
    if (postNode && postNode.title && (postSEO || pageSEO || gallerySEO)) {
    ...
    if (postNode && (postSEO || pageSEO || gallerySEO)) {
    ...
    return (
      <Helmet>
        ...
        <meta
          name="keywords"
          content="jp,valery,jpvalery,jp valery,photographer,photographe,photo,portfolio"
        />
